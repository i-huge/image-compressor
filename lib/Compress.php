...
class Compress
{
     ...
     */
    public function __construct($src, $percent=1, $maxWidth = -1, $maxHeight = -1)
    {
        $this->src = $src;
    ...
    {
        if ($this->percent == 0) {
            $new_width = $this->maxWith != -1 ? $this->maxWith : $this->imageinfo['width'];
            $new_height = $this->maxHeight != -1 ? $this->maxHeight : $this->imageinfo['height'];
        } else {
